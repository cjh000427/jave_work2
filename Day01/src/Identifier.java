...
//		int my birth day = 20000427; (X)
		int mybirthday = 20000427;
		int myBirthDay = 20000427; //camel case
...
//		String class = "클래스"; (X)
		String Class = "클래스"; //(가능은 하나 권장하지 않습니다.)
...
//		int sutja = 10; (X)
		...
		//식별자는 소문자로, 클래스는 앞글자 대문자로, 변수는 명사로
		//함수(메서드)는 동사(소문자)로, 변수의 이름은 파악가능하게
