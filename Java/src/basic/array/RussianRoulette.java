...
public class RussianRoulette {
	...
	public static void main(String[] args) {
        ...
        */
		...
		while(true) {
			System.out.println("게임 인원을 입력하세요(2명~4명): ");
			...
			if(player == 2) {
				...
				System.out.println("게임 인원을 다시 입력하세요.");
			}
		...
		System.out.print("실탄의 개수를 입력하세요: ");
		...
		while(true) {
			...
			System.out.println("생성된 난수: " + rn1);// 
			
			if(bulletPos[rn1] == true) {
				continue;
			}
			...
			if(bullet == checkNum) break;
			
		}
		System.out.println(Arrays.toString(bulletPos));// 실탄이 잘 장전됬는지
